...
- [`expint1`](@ref PureSpecial.expint1)
- [`expint`](@ref PureSpecial.expint), [`expintx`](@ref PureSpecial.expintx)
- [`expinti`](@ref PureSpecial.expinti)

### Logarithmic integral

- [`logint`](@ref PureSpecial.logint)

## Trigonometric Integral

- [`sinint`](@ref PureSpecial.sinint), [`cosint`](@ref PureSpecial.cosint)
- [`sinhint`](@ref PureSpecial.sinhint), [`coshint`](@ref PureSpecial.coshint)
